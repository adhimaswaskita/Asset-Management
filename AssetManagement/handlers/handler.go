...
type IHandler interface {
	...
	//Dashboard
	TotalAsset(w http.ResponseWriter, r *http.Request)
	TotalInStoreAsset(w http.ResponseWriter, r *http.Request)
	TotalInUseAsset(w http.ResponseWriter, r *http.Request)
	TotalInRepairAsset(w http.ResponseWriter, r *http.Request)
	ITAssetSummary(w http.ResponseWriter, r *http.Request)
	TopFiveITAssets(w http.ResponseWriter, r *http.Request)
	NonITAssetSummary(w http.ResponseWriter, r *http.Request)
	TopFiveNonITAssets(w http.ResponseWriter, r *http.Request)
